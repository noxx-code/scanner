...
from secscan.fingerprint.signatures import HEADER_TECH_SIGNATURES, HTML_LIBRARY_PATTERNS, MOCK_VULN_MINIMUMS
from secscan.utils.http import make_client
from secscan.utils.models import CrawlResult, Fingerprint
