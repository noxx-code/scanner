...
def create_access_token(subject: str, expires_delta: Optional[timedelta] = None) -> str:
    ...
    """
    delta = expires_delta or timedelta(minutes=30)  # Default 30 minutes
...
def is_account_locked(username: str, max_attempts: int = 5, window_seconds: int = 300) -> bool:
    """
    ...
    recent = [t for t in _login_attempts[username] if now - t < window_seconds]
