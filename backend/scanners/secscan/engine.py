"""
Refactored SecScan scanner - unified interface version.
...
class SecscanScanner(BaseScanner):
    """Simplified SecScan implementation with unified interface."""

    def __init__(self, timeout: int = 10):
        """Initialize SecScan scanner.

        Args:
            timeout: HTTP request timeout in seconds
        """
        super().__init__("secscan")
